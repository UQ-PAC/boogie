// https://gitlab.com/sosy-lab/benchmarking/sv-benchmarks/-/blob/main/c/bitvector-loops/diamond_2-1.c
// Arithmetic
...
procedure main() {
  ...
  while (bv64ult(x,99bv64)) {
    if (bv64urem(y, 2bv64) == 0bv64) {
      x := bv64add(x, 1bv64);
    } else {
      x := bv64add(x, 2bv64);
    }
  ...
  assert(bv64urem(x, 2bv64) != bv64urem(y, 2bv64));
